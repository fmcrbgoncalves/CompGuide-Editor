...
public class EditPlanPage12 extends AbstractOWLWizardPanel {

	public static final String ID = "EditPlanPage12";
	...
	public EditPlanPage12(OWLEditorKit owlEditorKit, String individual) {
	...
	public Object getNextPanelDescriptor() {
		if (paralleltask.isSelected()) {
			choice = 1;
			return EditPlanPage13parallel.ID;
		} else if (preferencealternativetask.isSelected()) {
			choice = 2;
			return EditPlanPage13preferencealternative.ID;
		} else if (alternativetask.isSelected()) {
			choice = 3;
			return EditPlanPage13alternative.ID;
		} else if (nexttask.isSelected()) {
			choice = 4;
			return EditPlanPage13next.ID;
		} else
			choice = -1;
