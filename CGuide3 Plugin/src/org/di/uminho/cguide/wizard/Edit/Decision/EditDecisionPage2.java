...
public class EditDecisionPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "EditDecisionPage2";
	...
	public EditDecisionPage2(OWLEditorKit owlEditorKit, String individual) {
