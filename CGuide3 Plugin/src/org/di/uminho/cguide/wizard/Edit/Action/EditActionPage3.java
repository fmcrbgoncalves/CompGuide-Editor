...
public class EditActionPage3 extends AbstractOWLWizardPanel {

	public static final String ID = "EditActionPage3";

	public static final String title = "Action Periodicity Restrictions";
	...
	public EditActionPage3(OWLEditorKit owlEditorKit, String individual) {
