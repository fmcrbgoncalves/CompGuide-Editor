...
public class EditQuestionPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "EditQuestionPage2";

	public static final String title = "Insert Question Data Required";
	...
	public EditQuestionPage2(OWLEditorKit owlEditorKit, String individual) {
		super(ID, title, owlEditorKit);
		getIndividual(individual);
	}

	protected void createUI(JComponent parent) {
		setInstructions("Please insert data required for the creation of the associated Question.");
		...
		plan_description_label = new JLabel("Clinical Question Description:");
