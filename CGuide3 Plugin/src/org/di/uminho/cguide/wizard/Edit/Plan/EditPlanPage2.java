...
public class EditPlanPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "EditPlanPage2";

	public static final String title = "Insert Plan Data Required";
	...
	public EditPlanPage2(OWLEditorKit owlEditorKit, String individual) {
	...
	protected void createUI(JComponent parent) {
		...
		plan_description_label = new JLabel("Clinical Plan Description:");
