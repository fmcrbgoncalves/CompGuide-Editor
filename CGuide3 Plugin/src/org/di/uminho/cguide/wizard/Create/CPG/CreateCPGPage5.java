...
public class CreateCPGPage5 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateCPGPage5";
	...
	public CreateCPGPage5(OWLEditorKit owlEditorKit) {
	...
	protected void createUI(JComponent parent) {
		...
		for (OWLNamedIndividual a : getClinicalSpeciality()) {
