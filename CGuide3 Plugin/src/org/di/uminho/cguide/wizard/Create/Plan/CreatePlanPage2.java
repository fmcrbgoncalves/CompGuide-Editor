...
public class CreatePlanPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "CreatePlanPage2";
	...
	public CreatePlanPage2(OWLEditorKit owlEditorKit) {
