...
public class CreateEndPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateEndPage2";
	...
	public CreateEndPage2(OWLEditorKit owlEditorKit) {
