...
public class CreateActionPage3 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateActionPage3";
	...
	public CreateActionPage3(OWLEditorKit owlEditorKit) {
