...
public class CreatePlanPage10 extends AbstractOWLWizardPanel {

	public static final String ID = "CreatePlanPage10";
	...
	public CreatePlanPage10(OWLEditorKit owlEditorKit) {
	...
	protected void createUI(JComponent parent) {
		 ...
		 * GridBagConstraints gbc_repetitionvalue_label = new
		 * GridBagConstraints(); gbc_repetitionvalue_label.anchor =
		 * GridBagConstraints.EAST; gbc_repetitionvalue_label.insets = new
		 * Insets(0, 0, 5, 5); gbc_repetitionvalue_label.gridx = 1;
		 ...
		 * repetitionvalue_textfield.setColumns(10); GridBagConstraints
		 * gbc_repetitionvalue_textfield = new GridBagConstraints();
