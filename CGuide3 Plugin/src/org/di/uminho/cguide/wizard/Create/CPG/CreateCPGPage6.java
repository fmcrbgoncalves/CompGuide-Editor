...
public class CreateCPGPage6 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateCPGPage6";
	...
	public CreateCPGPage6(OWLEditorKit owlEditorKit) {
	...
	protected void createUI(JComponent parent) {
		...
		for (OWLNamedIndividual a : getClinicalCategory()) {
	...
	public Object getBackPanelDescriptor() {
		return CreateCPGPage5.ID;
	}

	public Object getNextPanelDescriptor() {
		return CreateCPGPage7.ID;
	}
