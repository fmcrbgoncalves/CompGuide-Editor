...
public class CreateQuestionPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateQuestionPage2";
	...
	public CreateQuestionPage2(OWLEditorKit owlEditorKit) {
