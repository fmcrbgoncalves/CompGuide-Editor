...
public class CreateActionPage2 extends AbstractOWLWizardPanel {

	public static final String ID = "CreateActionPage2";
	...
	public CreateActionPage2(OWLEditorKit owlEditorKit) {
